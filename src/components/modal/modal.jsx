    ...
    <div className={s.modalContainer} onClick={props.handleClick} >
      <div className={s.modal} onClick={(event)=> {event.stopPropagation()}}>
        <div className={s.upPanel}>
          ...
          {props.closeButton ? 
          (<button className={s.btnExit} onClick={props.handleClick}>
        ...
        <div className={s.btnsContainer}>
          <button className={s.btn} onClick={props.handleClick}>Ok</button>
          <button className={s.btn} onClick={props.handleClick}>Cancel</button>
        </div>
      </div>
    </div>
  );
